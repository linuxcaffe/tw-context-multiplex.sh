...
_provides command cmx to apply and mange multiple contexts simultaneously_
...
```
then the value of context.cmx.read becomes;
```
...
| `cmx show` | lists the current set of active contexts |
